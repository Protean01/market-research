...
return [
    ...
    */
    ...
    // Feature flag to log OTP codes for testing; default off for security
    'log_otp' => env('APP_LOG_OTP', false),
    ...
    // Allow admin/staff to submit surveys (useful for local testing)
    'allow_admin_submissions' => env('ALLOW_ADMIN_SUBMISSIONS', false),
